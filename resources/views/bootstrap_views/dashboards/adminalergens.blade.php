        ...
        @include('bootstrap_views.partials.sidenav')
            <div class="col-lg-10 col-sm-12 display-data mt-5">
                ...
                <div class="row d-flex justify-content-center my-5">
                    <a class="btn btn-domasno w-20 rounded-pill" href="{{ route('add.alergen') }}">
                        Add New Alergen
                    </a>
                </div>
                <div class="row mt-5">
                            ...
                            <tbody>
                                @foreach ($alergens as $alergen)
                                    <tr>
                                        ...
                                        <td>{{ $alergen->alergen_name }}</td>
                                        <td class="d-flex justify-content-around flex-wrap">


                                            <a class="btn btn-sm btn-warning rounded-pill px-3"
                                                href="{{ route('edit.alergen', $alergen->id) }}">Edit</a>

                                            <button type="submit"
                                                class="btn btn-sm btn-danger rounded-pill px-3 btn-delete-alergen"
                                                data-id="{{$alergen->id}}">Delete</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
